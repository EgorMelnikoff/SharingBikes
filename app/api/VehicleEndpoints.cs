...
public static class VehicleEndpoints
{
    public static RouteGroupBuilder MapVehiclesEndpoints(this RouteGroupBuilder api)
    {
        ...
        group.MapGet("/{vehicleId:guid}",
                async (Guid vehicleId, IVehicleService vehicles, IMapper mapper) =>
            {
        ...
        group.MapPatch("/{vehicleId:guid}",
                async (Guid vehicleId, PatchVehicleRequest body, IVehicleService vehicles, IMapper mapper) =>
            {
                try
                {
        ...
        group.MapDelete("/{vehicleId:guid}",
                async (Guid vehicleId, IVehicleService vehicles) =>
            {
                try
                {
